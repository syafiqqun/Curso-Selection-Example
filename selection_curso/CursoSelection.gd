...
func _input(event: InputEvent) -> void:
	update_curso_position(grid_colums)
...
func initialize_curso_selection():
	...
	generate_first_last_offset_ref_index(grid_colums, nodes_pos.size())
	generate_first_last_true_offset_ref_index(grid_colums)
...
func debug_output_value_generated():
	if initial_debug == true:
		print("Grids Column: ", grid_colums)
